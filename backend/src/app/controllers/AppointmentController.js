...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    if (req.userId === provider_id) {
      return res.status(400).json({ error: 'This commitment cannot be created' })
    }
  ...
  async delete(req, res) {
    ...
    if (appointment.user_id !== req.userId) {
      return res.json(401).json({ error: 'You don´t have permission to cancel this appointment' });
    }
